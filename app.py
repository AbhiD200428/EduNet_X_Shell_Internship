...
# Comparing historical and forecasted cumulative EVs
...
if multi_counties:
    ...
    # Displays percentage growth for county that is selected
    growth_summaries = []
    for cty in multi_counties:
    ...
    # joining the responses and sending it to be displaed with st.success
    growth_sentence = " | ".join(growth_summaries)
    st.success(f"Forecasted EV adoption growth over next 3 years — {growth_sentence}")

st.success("Forecast complete")

st.markdown("Prepared for the **AICTE Internship Cycle 2 (Week 3) by Abhilash Dash**")